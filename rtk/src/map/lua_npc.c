...
lua_type_class lua_npc_type;

/* Push instance macros */
#define lua_npc_pushinst(state, nd) lua_type_pushinst(state, &lua_npc_type, nd, 0)
#define npcregl_pushinst(state, nd) lua_type_pushinst(state, &npcregl_type, nd, 0)
#define mapregl_pushinst(state, nd) lua_type_pushinst(state, &mapregl_type, nd, 0)
#define gameregl_pushinst(state, nd) lua_type_pushinst(state, &gameregl_type, nd, 0)

/*==============================================================================
 * NPC Type Implementation
 *============================================================================*/

void lua_npc_staticinit() {
	lua_npc_type = lua_type_new("NPC", lua_npc_ctor);
	lua_npc_type.init = lua_npc_init;
	lua_npc_type.getattr = lua_npc_getattr;
	lua_npc_type.setattr = lua_npc_setattr;
	lua_type_extendproto(&lua_npc_type, "move", lua_npc_move);
	lua_type_extendproto(&lua_npc_type, "warp", lua_npc_warp);
	lua_type_extendproto(&lua_npc_type, "getEquippedItem", lua_npc_getequippeditem);
	lua_blocklist_extendproto(&lua_npc_type);
}
 ...
 * 3. Add #include "lua_npc.h" to sl.h
 * 4. Rebuild and test
 *============================================================================*/
