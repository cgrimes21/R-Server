...
#include <string.h>
#include <math.h>
#include "clif_visual.h"
#include "clif_crypto.h"
#include "clif.h"
#include "core.h"
#include "map.h"
#include "socket.h"
...
/* Note: The following functions are very large (200-300 lines each) and remain in clif.c:
 * - clif_cnpclook_sub() - NPC character look packet builder
 * - clif_cmoblook_sub() - Mob character look packet builder
 * - clif_charlook_sub() - Player character look packet builder
 * - clif_object_look_sub2() - Object look packet variant
 * - clif_object_look_specific() - Specific object look
 *
 * These will be moved in a future iteration or left in clif.c
