...
#define mapregl_pushinst(state, mob) typel_pushinst(state, &mapregl_type, mob, 0)
#define gameregl_pushinst(state, mob) typel_pushinst(state, &gameregl_type, mob, 0)
...
void mobl_staticinit() {
	...
	typel_extendproto(&mobl_type, "hasDurationID", mobl_hasdurationid);
 ...
 * 3. Add #include "sl_mob.h" to sl.h
 * 4. Rebuild and test
 *============================================================================*/
